/*
 * NIntentFilterAddDataSchemeOpNode.java - part of the GATOR project
 *
...
public class NIntentFilterAddDataSchemeOpNode extends NOpNode {
  public static final SootMethod METHOD = Scene.v().getMethod("<android.content.IntentFilter: void addDataScheme(java.lang.String)>");

  public NIntentFilterAddDataSchemeOpNode(NVarNode receiver, NNode scheme,
                                          Pair<Stmt, SootMethod> callSite) {
    super(callSite, false);
    receiver.addEdgeTo(this);
    scheme.addEdgeTo(this);
  }
