...
public interface MethodNames {
  ...
  String setContentViewViewParaSubSig =
  ...
  String onCreateContextMenuSubSig =
  ...
  //             later.
  String tabSpecSetContentIntentSubSig =
  ...
  // Added in API level 8
  String activityOnCreateDialogBundleSubSig =
  ...
  // Added in API level 8
  String activityOnPrepareDialogBundleSubSig =
  ...
  // start activity
  String activityStartActivityForResultSubSig =
