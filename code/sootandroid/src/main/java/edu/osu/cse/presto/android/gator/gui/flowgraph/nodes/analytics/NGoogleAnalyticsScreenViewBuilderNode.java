/*
 * NGoogleAnalyticsScreenViewBuilderNode.java - part of the GATOR project
 *
...
public class NGoogleAnalyticsScreenViewBuilderNode extends NAllocNode {
  public Stmt allocStmt;
  public SootMethod allocMethod;

  public NGoogleAnalyticsScreenViewBuilderNode(Expr e, Stmt allocStmt, SootMethod allocMethod) {
    this.e = e;
