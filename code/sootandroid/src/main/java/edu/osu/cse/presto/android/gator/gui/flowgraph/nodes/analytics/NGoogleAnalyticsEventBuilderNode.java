/*
 * NGoogleAnalyticsEventBuilderNode.java - part of the GATOR project
 *
...
public class NGoogleAnalyticsEventBuilderNode extends NAllocNode {
  public Stmt allocStmt;
  public SootMethod allocMethod;

  public NGoogleAnalyticsEventBuilderNode(Expr e, Stmt allocStmt, SootMethod allocMethod) {
    this.e = e;
