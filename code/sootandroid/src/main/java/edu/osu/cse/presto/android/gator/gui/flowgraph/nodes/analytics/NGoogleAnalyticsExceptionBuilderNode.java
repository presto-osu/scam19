/*
 * NGoogleAnalyticsExceptionBuilderNode.java - part of the GATOR project
 *
...
public class NGoogleAnalyticsExceptionBuilderNode extends NAllocNode {
  public Stmt allocStmt;
  public SootMethod allocMethod;

  public NGoogleAnalyticsExceptionBuilderNode(Expr e, Stmt allocStmt, SootMethod allocMethod) {
    this.e = e;
