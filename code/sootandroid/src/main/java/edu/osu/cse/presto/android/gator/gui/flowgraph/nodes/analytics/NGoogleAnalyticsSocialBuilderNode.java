/*
 * NGoogleAnalyticsSocialBuilderNode.java - part of the GATOR project
 *
...
public class NGoogleAnalyticsSocialBuilderNode extends NAllocNode {
  public Stmt allocStmt;
  public SootMethod allocMethod;

  public NGoogleAnalyticsSocialBuilderNode(Expr e, Stmt allocStmt, SootMethod allocMethod) {
    this.e = e;
