/*
 * NIntentFilterAddDataAuthorityOpNode.java - part of the GATOR project
 *
...
public class NIntentFilterAddDataAuthorityOpNode extends NExtOpNode {
  public static final SootMethod METHOD = Scene.v().getMethod("<android.content.IntentFilter: void addDataAuthority(java.lang.String,java.lang.String)>");

  public NIntentFilterAddDataAuthorityOpNode(NVarNode receiver, NNode param1, NNode param2,
